...
extern struct prefix_list *prefix_list_lookup (uint8_t, const char *);
extern enum prefix_list_type prefix_list_apply (struct prefix_list *, void *);

extern struct prefix_list *prefix_bgp_orf_lookup (uint8_t, const char *);
extern struct stream * prefix_bgp_orf_entry (struct stream *,
                                             struct prefix_list *,
                                             u_char, u_char, u_char);
extern int prefix_bgp_orf_set (char *, uint8_t, struct orf_prefix *, int, int);
extern void prefix_bgp_orf_remove_all (uint8_t, char *);
extern int prefix_bgp_show_prefix_list (struct vty *, uint8_t, char *);
