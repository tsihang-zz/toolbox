...
prefix_list_lookup_do (uint8_t afi, int orf, const char *name)
{
...
struct prefix_list *
prefix_list_lookup (uint8_t afi, const char *name)
{
  return prefix_list_lookup_do (afi, 0, name);
}

struct prefix_list *
prefix_bgp_orf_lookup (uint8_t afi, const char *name)
{
...
static struct prefix_list *
prefix_list_insert (uint8_t afi, int orf, const char *name)
{
  unsigned int i;
  long number;
  struct prefix_list *plist;
...
static struct prefix_list *
prefix_list_get (uint8_t afi, int orf, const char *name)
{
  struct prefix_list *plist;
...
static int
vty_prefix_list_install (struct vty *vty, uint8_t afi, const char *name, 
...
static int
vty_prefix_list_uninstall (struct vty *vty, uint8_t afi, const char *name, 
                           const char *seq, const char *typestr,
			   const char *prefix, const char *ge, const char *le)
{
  int ret;
...
static int
vty_prefix_list_desc_unset (struct vty *vty, uint8_t afi, const char *name)
{
  struct prefix_list *plist;
...
static void
vty_show_prefix_entry (struct vty *vty, uint8_t afi, struct prefix_list *plist,
...
static int
vty_show_prefix_list (struct vty *vty, uint8_t afi, const char *name,
...
static int
vty_show_prefix_list_prefix (struct vty *vty, uint8_t afi, const char *name, 
...
static int
vty_clear_prefix_list (struct vty *vty, uint8_t afi, const char *name, 
                       const char *prefix)
{
  struct prefix_master *master;
  struct prefix_list *plist;
...
static int
config_write_prefix_afi (uint8_t afi, struct vty *vty)
{
  struct prefix_list *plist;
  struct prefix_list_entry *pentry;
  struct prefix_master *master;
...
int
prefix_bgp_orf_set (char *name, uint8_t afi, struct orf_prefix *orfp,
		    int permit, int set)
{
  struct prefix_list *plist;
  struct prefix_list_entry *pentry;
...
void
prefix_bgp_orf_remove_all (uint8_t afi, char *name)
{
  struct prefix_list *plist;
...
/* return prefix count */
int
prefix_bgp_show_prefix_list (struct vty *vty, uint8_t afi, char *name)
{
  struct prefix_list *plist;
  struct prefix_list_entry *pentry;
...
static void
prefix_list_reset_afi (uint8_t afi, int orf)
{
  struct prefix_list *plist;
